...
class plgJshoppingProductsBa_custom_fields extends JPlugin {
	...
	public function onBeforeDisplayProductList(&$products) {
		...
		$doc->addStyleSheet($baseUrl . 'plugins/jshoppingproducts/ba_custom_fields/ba_custom_fields.css?ver=0.0.3');
	...
	public function onBeforeDisplayProductView(&$view) {
		...
		$jshopConfig = JSFactory::getConfig();
		$doc = JFactory::getDocument();
		$doc->addStyleSheet($baseUrl . 'plugins/jshoppingproducts/ba_custom_fields/ba_custom_fields.css?ver=0.0.7');
